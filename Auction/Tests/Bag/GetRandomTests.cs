...
namespace Auction.Tests.Bag {
    ...
    [TestClass] public class GetRandomTests : BaseTests {
        ...
        [TestMethod] public void ValueTest() {
            ...
            test(typeof(string));
            test(typeof(object));
            test(typeof(BidDbRecord));
        }

        [TestMethod] public void ObjectTest() {
            Assert.IsNull(GetRandom.Object(null));
            var o = GetRandom.Object(typeof(BidDbRecord)) as BidDbRecord;
            Assert.IsNotNull(o);
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.ID));
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.ProductId));
            Assert.IsFalse(string.IsNullOrWhiteSpace(o.UserId));
