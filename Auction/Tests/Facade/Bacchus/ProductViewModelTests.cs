...
namespace Auction.Tests.Facade.Bacchus {
    [TestClass] public class ProductViewModelTests : ObjectTests<ProductViewModel> {
        protected override ProductViewModel getRandomTestObject() {
            return GetRandom.Object<ProductViewModel>();
        }
